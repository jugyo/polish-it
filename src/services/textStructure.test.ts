...
import { extractTextStructure, restoreTextStructure, type TextStructure } from './textStructure';
...
describe('textStructure', () => {
  ...
  describe('Windows line endings (CRLF)', () => {
    ...
    it.todo('should handle mixed CRLF content with indentation (not yet supported)');
